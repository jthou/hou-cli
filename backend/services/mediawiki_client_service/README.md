...
```python
from backend.services.mediawiki_client_service import MediaWikiSyncService
...
```bash
# 单元测试
python -m pytest backend/services/mediawiki_client_service/tests/

# 特定测试
python -m pytest backend/services/mediawiki_client_service/tests/test_client.py
```
