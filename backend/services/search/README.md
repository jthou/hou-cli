...
```python
from backend.services.search import QueryBuilder
...
```bash
python -m pytest backend/services/search/tests/
```

运行特定测试：

```bash
python -m pytest backend/services/search/tests/test_macos_search.py
python -m pytest backend/services/search/tests/test_query_builder.py
python -m pytest backend/services/search/tests/test_integration.py
python -m pytest backend/services/search/tests/test_performance.py
```
