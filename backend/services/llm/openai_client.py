...
class OpenAIClient:
    """OpenAI 客户端（通过 TheTurbo.ai 网关，兼容 OpenAI API 格式）"""
    ...
    def __init__(self, api_key: str, base_url: Optional[str] = None):
        ...
        Args:
            api_key: OpenAI API Key（通过 TheTurbo.ai 网关）
        ...
        logger.info(f"OpenAI 客户端已初始化，base_url: {self.base_url}")
