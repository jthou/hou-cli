...
from backend.api.ai_hot_news_routes import router as ai_hot_news_router
...
router.include_router(tavily_audit_router, tags=["tavily-audit"])
...
router.include_router(ai_hot_news_router, tags=["ai-hot-news"])
