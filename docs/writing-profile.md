...
写作助手会根据**写作画像**记住你的喜好、表述习惯和范文，在生成文章时尽量贴合你的风格。
...
- **前端入口**：侧边栏 **工具 → 写作助手**，进入多轮对话页，与 Agent 对话完成定主题、改大纲、逐节写、润色等；由 **blog_writing** 技能 / **ArticleWritingAgent** 在对话中加载上述画像并在生成时注入。
