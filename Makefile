.PHONY: stop test restart start start-web build-web test-task-weather migrate help
...
help:
	@echo "用法: make <目标>"
	@echo "目标: stop | test | restart | start | start-web | build-web | test-task-weather | migrate"
