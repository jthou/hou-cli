...
/** 与 Markdown 预览共用外层 `p-4` 容器时使用，避免编辑/预览水平重复缩进、切换标签时错位 */
export const TEXTAREA_CLS_IN_PREVIEW_SHELL =
  'flex-1 min-h-[240px] w-full rounded-lg bg-[#1e293b] border border-border px-3 py-2.5 text-sm text-[#e2e8f0] placeholder-[#64748b] focus:outline-none focus:ring-1 focus:ring-cyan-500 resize-none font-mono leading-relaxed'
